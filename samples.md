...
<section class="hero-stage">
  <div class="subpage-shell wrapper">
    <main class="content-column">
      ...
      <p class="section-text">Selected examples of user documentation and structured technical guidance. API-focused samples are available separately under <a class="text-link" href="{{ "/REST_API.html" | relative_url }}">REST API Samples</a>.</p>
